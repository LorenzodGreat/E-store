...
<body>
    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://gadgets-africa.com/wp-content/uploads/2020/05/1_BGkB9VOJrhNPGuJDia8vgQ.jpeg);">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Shop Today</h1>
                <p class="text-3xl my-4">Get the best and latest phone avialabe in the contry.</p>
            </div>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style="background-image: url(https://gadgets-africa.com/wp-content/uploads/2020/05/1_BGkB9VOJrhNPGuJDia8vgQ.jpeg);">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
    ...
    <a href="https://www.buymeacoffee.com/danimai" target="_blank" class="bg-red-600 p-2 rounded-lg text-white fixed right-0 bottom-0">
        Seek Repair
    </a>
