                ...
                <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
                     <form class="divide-y divide-gray-200 lg:col-span-9" action="#" method="POST">
                        ...
                        <div class="py-6 px-4 sm:p-6 lg:pb-8">
                            <div>
                                <h2 class="text-lg leading-6 font-medium text-gray-900">Seek Help Today</h2>
                                <p class="mt-1 text-sm text-gray-500">Get the help you need fixing your favorite phone todday just fill in the form below and ask for help.</p>
                            </div>
                            ...
                            <div class="mt-6 flex flex-col lg:flex-row">
                                <div class="flex-grow space-y-6">
                                    ...
                                    <div>
                                        <label for="about" class="block text-sm font-medium text-gray-700"> About
                                        </label>
                                        <div class="mt-1">
