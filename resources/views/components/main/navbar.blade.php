<div x-data="{ modelOpen: false }">
    ...
    <div style=" background-color:#E5E708;" class="text-center font-semibold text-sm">
        <h4>Site slogan or catch phrase here</h4>
    </div>
    <nav style=" background-color:#494738;" class="bg-white shadow">
            ...
            <div class="flex justify-between h-16">
              ...
              -->
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="/" style="color:#E5E708; border-color:#E5E708"
                            class="text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Home </a>
                        <a href="/Products"
                            class="border-transparent nav-link inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            New Phones </a>
                        <a href="/Products"
                            class="border-transparent nav-link inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Old Phones</a>
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <button type="button"
                            class="relative nav-btn inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <span>Register </span>
                        </button>

                        <button type="button"
                            class="relative nav-btn ml-2 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <span> Login </span>
                        </button>
                    </div>
              ...
              -->
                            <div x-cloak @click="modelOpen = false" x-show="modelOpen" @click.away="modelOpen = false"
