...
<div class="bg-white">
    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-xl font-bold text-gray-900">New Products</h2>
      ...
      <div class="mt-8 grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
        <div>
          ...
          <div class="mt-6">
            <a href="#" class="relative flex bg-red-600 border border-transparent rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-white hover:bg-red-700">Add to bag<span class="sr-only">, Zip Tote Basket</span></a>
          </div>
        </div>
